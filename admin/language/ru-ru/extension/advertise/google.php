...
$_['text_checklist_acknowledge_0']          = '<h4>Видимость каталога товаров</h4><p>Я подтверждаю, что мой каталог товаров доступен для общественности без пароля.</p>';
$_['text_checklist_acknowledge_1']          = '<h4>Процесс оформления покупки</h4><p>Обработка платежей и транзакций, а также сбор любой конфиденциальной и финансовой персональной информации от пользователя, осуществляются через защищенный сервер обработки (SSL-protected, с действующим SSL сертификатом-https://).</p>';
$_['text_checklist_acknowledge_2']          = '<h4>Политика возврата</h4><p>Я подтверждаю, что мой сайт предоставляет четкую и заметную политику возврата пользователям.</p>';
...
$_['text_checklist_acknowledge_4']          = '<h4>Точная контактная информация</h4><p>Я подтверждаю, что мой сайт содержит достаточную и точную контактную информацию с <em>по крайней мере два контакта</em> из следующих: номер телефона, физический адрес, адрес электронной почты.</p>';
$_['text_checklist_intro']                  = '<h3>Внимание</h3> Прежде чем размещать объявления в Google, ваш интернет-магазин должен соответствовать требованиям Google Merchant Center. Полный список всех требований и рекомендаций можно найти <a href="https://support.google.com/merchants/answer/6363310?hl=ru" target="_blank"><strong>тут</strong></a>.';
...
$_['text_panel_heading']                    = 'Настройка Google Shopping | Магазин: %s';
