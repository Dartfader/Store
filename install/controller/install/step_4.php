...
class ControllerInstallStep4 extends Controller {
	public function index() {
		...
		$data['text_site_description'] = $this->language->get('text_site_description');
		$data['text_site_visit'] = $this->language->get('text_site_visit');
		...
		$data['text_marketplace_description'] = $this->language->get('text_marketplace_description');
		$data['text_marketplace_visit'] = $this->language->get('text_marketplace_visit');
